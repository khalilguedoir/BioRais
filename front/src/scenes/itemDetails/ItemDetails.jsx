import { Box, Button, Divider, IconButton, Link, MenuItem, Select, Stack, Typography } from "@mui/material";
...
const ItemDetails = () => {
  ...
  return (
    <Box width="80%" m="80px auto" mt="200px" >
      <Box display="flex" flexWrap="wrap" columnGap="40px">
        ...
        <Box flex="1 1 50%" mb="40px">
          <Box display="flex" justifyContent="space-between">
            <Box>
              <Link href={`/category/${item?.attributes?.category.data.id}`} sx={{ color: "inherit", textDecoration: "none", ":hover": { color: "gray" } }}>
          ...
          <Stack m="65px 0 25px 0" spacing="20px" sx={{ direction: "rtl" }}>
            ...
            <Typography
              ...
              sx={{
                ...
                textDecoration: item?.attributes?.prix_en_promo != undefined ? "line-through" : "",
                color: item?.attributes?.prix_en_promo != undefined ? "red" : "#04bbac",
              }}
            >
            ...
            </Typography>
            {
              item?.attributes?.prix_en_promo != undefined && (
                ...
                >
                  {item?.attributes?.prix_en_promo != undefined && item?.attributes?.prix_en_promo}DT
                </Typography>
              )
            }
      ...
      <Box mt="50px" width="100%">
        ...
        >
          ...
          {items && items.filter(p => p.attributes.category.data.id === item.attributes.category.data.id && p.id != itemId).slice(0, 4).map((product, index) => (
